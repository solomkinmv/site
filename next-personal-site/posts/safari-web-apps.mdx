...
draft: false
tags: ["macos"]
summary: "Safari web apps on Mac let you turn websites like Fastmail and ChatGPT into standalone apps without third-party tools."
description: "Discover how to use Safari's native web app feature on Mac to create seamless app experiences without external tools for services like Fastmail and ChatGPT."
---

<Collapsible summary="TLDR (Prompt for ChatGPT):">
