---
title: "Fixing DnsNameResolverTimeoutException in Spring Boot"
date: 2024-06-17
draft: false
tags: ["spring-boot"]
summary: "Resolving DnsNameResolverTimeoutException in Spring Boot WebFlux by switching from Netty's DNS resolver to DefaultAddressResolverGroup."
description: "Fix DnsNameResolverTimeoutException errors in Spring Boot WebFlux applications by customizing the DNS resolver configuration and OAuth2 WebClient setup."
---
